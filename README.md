...
| journal-nolder-title              | The journal folder title is used in the rendering of journal headers as well as to identify the folder in other views. The journal folder title should typically be configured at folder level as it would typically be unique to that folder.                                                                                                                                                                                                                                                                                                                                                                                         |
