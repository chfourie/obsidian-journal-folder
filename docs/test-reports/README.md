...
### ✓ plugin is loaded and exposes settings _(726ms)_

1. Confirm the Journal Folder plugin is installed and active.

### ✓ daily note renders the journal header _(3022ms)_
...
### ✓ header is a no-op in a non-journal note _(1734ms)_
...
### ✓ daily note renders the folder title and H1 title _(2731ms)_
...
### ✓ backward navigation link targets the previous day _(2609ms)_
...
### ✓ More popover opens and shows a calendar toggle _(3052ms)_
...
### ✓ monthly note renders a header too _(2701ms)_
...
### ✓ a past note links forward to the next day _(2846ms)_
...
### ✓ calendar renders day cells and a weekday header _(3825ms)_
...
### ✓ an existing day cell is marked exists; a missing one is marked missing _(2882ms)_
...
### ✓ Year/Month picker opens with a month grid _(3144ms)_
...
### ✓ clicking a past empty day cell creates the note after confirmation _(4143ms)_
...
### ✓ prev / next arrows change the visible months _(4309ms)_
...
### ✓ the Current link jumps back to today’s month _(4252ms)_
...
### ✓ quarter cell appears only when quarters are enabled _(4260ms)_
...
### ✓ in-note journal-tasks block renders task rows _(2852ms)_
...
### ✓ plugin-rendered status icons are present (Bullet Journal flow) _(2777ms)_
...
### ✓ document-body checkboxes get the plugin swap marker _(3111ms)_
...
### ✓ sidebar task panel renders with a scope trigger _(3892ms)_
...
### ✓ tasks are grouped under their source note _(3769ms)_
...
### ✓ tasks matching a category appear in a category section _(4244ms)_
...
### ✓ the truncation footer appears when the item cap is hit _(4224ms)_
...
### ✓ left-click cycles open → in-progress and writes to disk _(3750ms)_
...
### ✓ right-click opens the status picker _(3287ms)_
...
### ✓ choosing a status from the picker persists it _(3793ms)_
...
### ✓ cycling from the sidebar panel also writes to disk _(4982ms)_
...
### ✓ theme-rendering flow keeps the native checkbox (no plugin icon swap) _(3444ms)_
...
### ✓ the migrate picker lists active tasks from sibling notes _(3977ms)_
...
### ✓ migrating stamps the origin and copies the task to the destination _(7187ms)_
...
### ✓ cancelling the picker changes nothing _(3288ms)_
...
### ✓ scope summary reflects the baseline scope _(3877ms)_
...
### ✓ scope panel opens with all four axes _(4434ms)_
...
### ✓ changing the range persists to settings _(4679ms)_
...
### ✓ changing the anchor persists to settings _(4638ms)_
...
### ✓ selecting all-folders persists to settings _(4682ms)_
...
### ✓ toggling show-completed persists to settings _(4687ms)_
...
### ✓ the quarter range option is gated by quartersEnabled _(7281ms)_
...
### ✓ reading view renders signifier icons in a gutter _(3167ms)_
...
### ✓ matched tag text is hidden in reading view _(3074ms)_
...
### ✓ margin-column placement adds the column modifier _(3066ms)_
...
### ✓ switching to per-row margin drops the column modifier _(3511ms)_
...
### ✓ live preview renders a gutter marker _(3055ms)_
...
### ✓ live preview reveals the tag on the active line, hides it elsewhere _(4105ms)_
...
### ✓ a template note renders the header with a TEMPLATE ribbon _(3474ms)_
...
### ✓ navigation chips are display-only — they link to the template itself _(2340ms)_

1. Confirm the header navigation chips link to the template file instead of real month notes.

### ✓ calendar cells are display-only but still report their real date _(3430ms)_
...
### ✓ a real journal note has no TEMPLATE ribbon _(3441ms)_
...
### ✓ the item appears for a journal note and overwrites it after confirm _(6715ms)_
...
### ✓ cancelling the confirmation leaves the note unchanged _(5861ms)_
...
### ✓ the item is absent for a non-journal note _(4885ms)_
...
### ✓ the item is absent when templating is disabled _(5207ms)_
...
### ✓ settings tab renders the tab strip _(2483ms)_
...
### ✓ the expected tabs exist _(2547ms)_
...
### ✓ clicking a tab swaps the active panel _(4732ms)_
...
### ✓ start-of-week dropdown persists _(3325ms)_
...
### ✓ a text field persists _(3339ms)_
...
### ✓ a note-title pattern persists (Patterns tab) _(3310ms)_
...
### ✓ adding a signifier persists and opens its editor _(3925ms)_
...
### ✓ adding then SAVING the editor keeps the list intact (3.0.1 regression) _(4054ms)_
...
### ✓ removing a signifier persists _(3356ms)_
...
### ✓ adding and removing a category persists (Tasks tab) _(4405ms)_
...
### ✓ task-flow drill-down and breadcrumb navigate _(4140ms)_
...
### ✓ sidebar shows the folder label and mode tag _(3892ms)_
...
### ✓ folder picker switches the selected folder _(4652ms)_
...
### ✓ More… menu lists the expected actions _(4210ms)_
...
### ✓ toggling the mode from the menu persists it _(4528ms)_
...
### ✓ dynamic mode follows the active note to its folder _(5345ms)_
...
### ✓ Initialise a new journal folder creates a seeded journal-folder.md _(5882ms)_
...
### ✓ Edit folder configuration writes a kebab-case override to front matter _(6224ms)_
...
### ✓ the ribbon menu command opens the panel with actions _(2326ms)_
...
### ✓ the theme toggle flips Obsidian’s color scheme _(2955ms)_
