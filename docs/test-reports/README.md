...
### ✓ plugin is loaded and exposes settings _(719ms)_

1. Confirm the Journal Folder plugin is installed and active.

### ✓ daily note renders the journal header _(3002ms)_
...
### ✓ header is a no-op in a non-journal note _(1772ms)_
...
### ✓ daily note renders the folder title and H1 title _(2921ms)_
...
### ✓ backward navigation link targets the previous day _(2679ms)_
...
### ✓ monthly note renders a header too _(2768ms)_
...
### ✓ a past note links forward to the next day _(2835ms)_
...
### ✓ calendar renders day cells and a weekday header _(2804ms)_
...
### ✓ an existing day cell is marked exists; a missing one is marked missing _(2821ms)_
...
### ✓ Year/Month picker opens with a month grid _(3118ms)_
...
### ✓ clicking a past empty day cell creates the note after confirmation _(4165ms)_
...
### ✓ prev / next arrows change the visible months _(4317ms)_
...
### ✓ the Current link jumps back to today’s month _(4166ms)_
...
### ✓ quarter cell appears only when quarters are enabled _(4247ms)_
...
### ✓ in-note journal-tasks block renders task rows _(2809ms)_
...
### ✓ plugin-rendered status icons are present (Bullet Journal flow) _(2764ms)_
...
### ✓ document-body checkboxes get the plugin swap marker _(3101ms)_
...
### ✓ sidebar task panel renders with a scope trigger _(3909ms)_
...
### ✓ tasks are grouped under their source note _(3802ms)_
...
### ✓ tasks matching a category appear in a category section _(4228ms)_
...
### ✓ left-click cycles open → in-progress and writes to disk _(3684ms)_
...
### ✓ right-click opens the status picker _(3362ms)_
...
### ✓ choosing a status from the picker persists it _(3849ms)_
...
### ✓ cycling from the sidebar panel also writes to disk _(4961ms)_
...
### ✓ theme-rendering flow keeps the native checkbox (no plugin icon swap) _(3546ms)_
...
### ✓ the migrate picker lists active tasks from sibling notes _(4008ms)_
...
### ✓ migrating stamps the origin and copies the task to the destination _(7136ms)_
...
### ✓ cancelling the picker changes nothing _(3317ms)_
...
### ✓ scope summary reflects the baseline scope _(3881ms)_
...
### ✓ scope panel opens with all four axes _(4469ms)_
...
### ✓ changing the range persists to settings _(4702ms)_
...
### ✓ changing the anchor persists to settings _(4709ms)_
...
### ✓ selecting all-folders persists to settings _(4713ms)_
...
### ✓ toggling show-completed persists to settings _(4652ms)_
...
### ✓ the quarter range option is gated by quartersEnabled _(7216ms)_
...
### ✓ reading view renders signifier icons in a gutter _(3092ms)_
...
### ✓ margin-column placement adds the column modifier _(3103ms)_
...
### ✓ switching to per-row margin drops the column modifier _(3487ms)_
...
### ✓ live preview renders a gutter marker _(3107ms)_
...
### ✓ live preview reveals the tag on the active line, hides it elsewhere _(4066ms)_
...
### ✓ a template note renders the header with a TEMPLATE ribbon _(3471ms)_
...
### ✓ navigation chips are display-only — they link to the template itself _(2324ms)_

1. Confirm the header navigation chips link to the template file instead of real month notes.

### ✓ calendar cells are display-only but still report their real date _(3465ms)_
...
### ✓ a real journal note has no TEMPLATE ribbon _(3423ms)_
...
### ✓ the item appears for a journal note and overwrites it after confirm _(6660ms)_
...
### ✓ cancelling the confirmation leaves the note unchanged _(5903ms)_
...
### ✓ the item is absent for a non-journal note _(4880ms)_
...
### ✓ the item is absent when templating is disabled _(5222ms)_
...
### ✓ settings tab renders the tab strip _(2539ms)_
...
### ✓ the expected tabs exist _(2556ms)_
...
### ✓ clicking a tab swaps the active panel _(4696ms)_
...
### ✓ start-of-week dropdown persists _(3254ms)_
...
### ✓ a text field persists _(3309ms)_
...
### ✓ a note-title pattern persists (Patterns tab) _(24754ms)_
...
### ✓ adding a signifier persists and opens its editor _(4036ms)_
...
### ✓ adding then SAVING the editor keeps the list intact (3.0.1 regression) _(4007ms)_
...
### ✓ removing a signifier persists _(3422ms)_
...
### ✓ adding and removing a category persists (Tasks tab) _(4369ms)_
...
### ✓ task-flow drill-down and breadcrumb navigate _(4088ms)_
...
### ✓ sidebar shows the folder label and mode tag _(3867ms)_
...
### ✓ folder picker switches the selected folder _(4576ms)_
...
### ✓ More… menu lists the expected actions _(4248ms)_
...
### ✓ dynamic mode follows the active note to its folder _(5321ms)_
...
### ✓ Initialise a new journal folder creates a seeded journal-folder.md _(5856ms)_
...
### ✓ Edit folder configuration writes a kebab-case override to front matter _(6192ms)_
...
### ✓ the ribbon menu command opens the panel with actions _(2317ms)_
...
### ✓ the theme toggle flips Obsidian’s color scheme _(2929ms)_
