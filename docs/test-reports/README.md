...
- [migration-reference-render](#migration-reference-render)
...
![Migration reference rendered as an icon in live preview](assets/migration-reference-render/01-migration-reference-rendered-as-an-icon-in-live-preview.png)
...
![Raw source mode keeps the literal lucide token](assets/migration-reference-render/02-raw-source-mode-keeps-the-literal-lucide-token.png)

*Raw source mode keeps the literal lucide token*
...
![Raw source mode shows tags verbatim, no gutter](assets/signifiers/06-raw-source-mode-shows-tags-verbatim-no-gutter.png)
...
![Active line reveals its tag, others stay hidden](assets/signifiers/07-active-line-reveals-its-tag-others-stay-hidden.png)
...
### ✓ a new journal note is seeded from the matching tier template file _(2309ms)_
